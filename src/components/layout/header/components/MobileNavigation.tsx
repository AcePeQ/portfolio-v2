  ...
  return (
    <>
      <div className="w-40 flex items-center justify-start lg:hidden">
        <button onClick={toggleMenu} className="w-8 cursor-pointer text-white-dark-hover hover:text-white-dark active:text-white-dark-active focus:text-white-dark">
          <MenuIcon />
        </button>
      </div>

      {isMenuOpen &&
        <div className="absolute z-20 h-[calc(100%-88px)] w-full top-22 left-0 bg-background">
